...
const TaxonomyHitsItem = (props) => {
  ...
  return (
    <div className={bemBlocks.item().mix(bemBlocks.container('item'))}>{result._source.name}</div>
  )
}
            ...
            <div className="sk-layout__body">
              <div className="sk-layout__filters">
                ...
                <RangeFilter
                  ...
                  field="taxonomy.level"
                  id="levelRange"
                  title="Taxonomy level range"
                  fieldOptions={{ type: 'nested', options: { path: 'taxonomy' } }}
                />

                <DynamicRangeFilter
                  field="taxonomy.level"
                  id="levelRangeDynamic"
                  title="Taxonomy level Dynamic range"
                  fieldOptions={{ type: 'nested', options: { path: 'taxonomy' } }}
                />
              </div>
