        ...
        <div className="grid grid-cols-1 md:grid-cols-12 md:gap-10">
          ...
          <div className="md:col-span-9 items-center flex justify-between md:justify-end  space-x-6 h-16">
            <div className="flex justify-between md:justify-end items-center flex-1 md:space-x-2">
              <div>
                <a href="/docs" className="rounded-md py-2 px-3 inline-flex items-center leading-5 font-medium text-gray-100 betterhover:hover:bg-gray-100 hover:text-gray-900 hover:bg-gray-200 focus:outline-none focus:text-gray-900 focus:bg-gray-200 transition duration-150 ease-in-out">
                  Docs
                </a>
              </div>
              <div>
                <a href="/github" className="rounded-md py-2 px-3 inline-flex items-center leading-5 font-medium text-gray-100 betterhover:hover:bg-gray-100 hover:text-gray-900 hover:bg-gray-200 focus:outline-none focus:text-gray-900 focus:bg-gray-200 transition duration-150 ease-in-out">
                Github <GithubLogo />
                </a></div>
            </div>
          </div>
...
const HeroImage = ({ src='img/m/search.jpeg', width="490px", height="400px" }) => {
        ...
        <div className="col-span-12 lg:col-span-5">
          ...
          <div className="mt-5  mx-auto sm:flex sm:justify-center lg:justify-start lg:mx-0 md:mt-8">
            ...
            <div className="rounded-md shadow ml-3">
              <a className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base leading-6 font-medium rounded-md text-gray-100 bg-gray-900 hover:bg-gray-900 focus:outline-none focus:border-gray-900 focus:shadow-outline-blue transition duration-150 ease-in-out md:py-4 md:text-lg md:px-10 border-gray-900" href="/docs/overview">View Demo</a>
            </div>
          </div>
        </div>
        <div className="hidden lg:block lg:col-span-7 mb-5 lg:mb-0">
          <HeroImage />
        </div>
      </div>
    </div>
          ...
          <div className="grid grid-cols-12 gap-4">
            ...
            <div className="lg:col-span-6 col-span-12 lg:pt-0 pt-6">
              <div className="text-center lg:text-left">
                ...
                <p className="mt-3 text-base text-gray-700 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">Searchkit uses Apollo & GraphQL to </p>
              ...
              <div className="flex flex-col justify-between mt-12 sm:flex-row">
                <div className="flex flex-col justify-between w-4/5">
                  <div className="flex flex-col justify-between">
                    <h3 className="text-xl font-bold mt-1">Search API in 60 seconds</h3>
                ...
                <div className="flex flex-col justify-between w-4/5 sm:ml-10">
                  <div className="flex flex-col justify-between mt-20 sm:mt-0">
                    <h3 className="text-xl font-bold mt-1">Integrated with Apollo</h3>
                    <p className="mt-1">Leverages Apollo</p>
                  </div>
                  <div className="flex flex-col justify-between mt-20">
                    <h3 className="text-xl font-bold mt-1">Easily build your own Facets</h3>
                    <p className="mt-1">kjvhdkjvhvjkhdjfvk jhkjh kjvhdkjvhvjkhdjfvk jhkjh kjvhdkjvhvjkhdjfvk jhkjh</p>
                  </div>
                </div>
              </div>
...
const FrontendIntro = () => {
  return (
    <div className="text-lg border-t border-gray-400 bg-gray-900">
      <div className="py-24 mx-auto container px-4 sm:mt-8 relative">
        <div className="md:col-span-6 col-span-12 md:pt-0 pt-6">
          <video playsInline autoPlay muted loop src={useBaseUrl("movs/search-demo.mov")} />
        </div>
