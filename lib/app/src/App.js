...
var App = (function (_super) {
    ...
    App.prototype.render = function () {
        return (React.createElement(core_1.SearcherProvider, {"searcher": this.primarySearcher}, React.createElement("div", {"className": "layout"}, React.createElement("div", {"className": "layout__search-box"}, React.createElement(components_1.SelectedFilters, null), React.createElement(components_1.SearchBox, null)), React.createElement("div", {"className": "layout__filters"}, React.createElement(components_1.ResetFilters, null), React.createElement(components_1.HierarchicalMenuFilter, {"fields": ["type.raw", "genres.raw"], "title": "Categories", "id": "categories"}), React.createElement(components_1.RefinementListFilter, {"title": "Actors", "field": "actors.raw", "operator": "AND"}), React.createElement(components_1.RefinementListFilter, {"title": "Languages", "field": "languages.raw", "operator": "OR"}), React.createElement(components_1.RefinementListFilter, {"title": "Countries", "field": "countries.raw", "operator": "OR"})), React.createElement("div", {"className": "layout__results-info"}, React.createElement(components_1.HitsStats, null)), React.createElement("div", {"className": "layout__results"}, React.createElement(MovieHits, {"hitsPerPage": 50}), React.createElement(components_1.Pagination, null)))));
    };
    return App;
