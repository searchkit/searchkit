...
describe("NoHits component", function () {
    ...
    describe("suggestions", function () {
        ...
        fit("suggest remove filters", function () {
            _this.createWrapper();
            // this.searchkit.getSelectedFilters = () => {
            //   return [{}]
            // }
            _this.searchkit.query = _this.searchkit.query.addFilter({});
            _this.searchkit.query = _this.searchkit.query.setQueryString("matrix");
            _this.searchkit.setResults({
                aggregations: {
                    "no_filters_top_hits": {
                        hits: {
