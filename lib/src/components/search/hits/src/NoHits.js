...
var NoHits = (function (_super) {
    ...
    NoHits.prototype.render = function () {
        if (this.hasHits() || this.isInitialLoading())
            return null;
        var suggestions = _.compact([this.renderSuggestions(), this.renderResetFilters()]);
        if (suggestions.length == 2) {
            suggestions.splice(1, 0, React.createElement("span", {"key": "or"}, " or "));
        }
        console.log(suggestions);
        return (React.createElement("div", {"data-qa": "no-hits", "className": this.bemBlocks.container()}, React.createElement("div", {"className": this.bemBlocks.container("info")}, this.translate("NoHits.NoResultsFound")), React.createElement("div", {"className": this.bemBlocks.container("steps")}, suggestions)));
    };
    NoHits.translations = {
