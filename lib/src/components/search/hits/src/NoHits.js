...
var NoHits = (function (_super) {
    ...
    NoHits.prototype.renderResetFilters = function () {
        ...
        if (!hasFilters)
            return null;
        return (React.createElement(core_1.FastClick, {"handler": this.resetFilters.bind(this)}, React.createElement("div", {"className": this.bemBlocks.container("reset-filters")}, this.translate("NoHits.SearchWithoutFilters", { query: "f" }))));
    };
    NoHits.prototype.setQueryString = function (query) {
        var queryAccessor = this.searchkit.getQueryAccessor();
        if (queryAccessor) {
