...
var NoHits = (function (_super) {
    ...
    NoHits.prototype.render = function () {
        if (this.hasHits() || this.isInitialLoading() || this.isLoading())
            return null;
        var query = this.getQuery().getQueryString();
        var suggestion = this.renderSuggestions() || this.renderResetFilters() || null;
        return (React.createElement("div", {"data-qa": "no-hits", "className": this.bemBlocks.container()}, React.createElement("div", {"className": this.bemBlocks.container("info")}, this.translate("NoHits.NoResultsFound", { query: query })), React.createElement("div", {"className": this.bemBlocks.container("steps")}, suggestion)));
    };
    NoHits.translations = {
