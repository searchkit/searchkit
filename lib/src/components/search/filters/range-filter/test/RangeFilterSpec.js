...
describe("Reset Filter tests", function () {
    ...
    it("renders limited range correctly", function () {
        _this.createWrapper(true);
        _this.wrapper.node.sliderUpdate([30, 70]);
        expect(_this.wrapper.find(".bar-chart").html()).toEqual(TestHelpers_1.jsxToHTML(React.createElement("div", {"className": "bar-chart"}, React.createElement("div", {"className": "bar-chart__bar bar-chart__bar-out", "style": { height: "20%" }}), React.createElement("div", {"className": "bar-chart__bar bar-chart__bar-out", "style": { height: "60%" }}), React.createElement("div", {"className": "bar-chart__bar", "style": { height: "20%" }}), React.createElement("div", {"className": "bar-chart__bar", "style": { height: "20%" }}), React.createElement("div", {"className": "bar-chart__bar", "style": { height: "20%" }}), React.createElement("div", {"className": "bar-chart__bar", "style": { height: "100%" }}), React.createElement("div", {"className": "bar-chart__bar", "style": { height: "20%" }}), React.createElement("div", {"className": "bar-chart__bar bar-chart__bar-out", "style": { height: "20%" }}), React.createElement("div", {"className": "bar-chart__bar bar-chart__bar-out", "style": { height: "20%" }}), React.createElement("div", {"className": "bar-chart__bar bar-chart__bar-out", "style": { height: "20%" }}))));
    });
});
