...
var RangeAccessor = (function (_super) {
    ...
    RangeAccessor.prototype.buildOwnQuery = function (query) {
        query = query.setAggs(core_1.FilterBucket(this.key, query.getFiltersWithoutKeys(this.key), core_1.HistogramBucket(this.key, this.options.field, {
...
var RangeFilter = (function (_super) {
    ...
    RangeFilter.prototype.render = function () {
        ...
        return (React.createElement("div", {"className": block()}, React.createElement("div", {"className": block("header")}, this.translate(this.props.title)), React.createElement("div", null, this.getHistogram()), React.createElement(Rcslider, {"min": this.props.min, "max": this.props.max, "range": true, "value": [
            _.get(this.accessor.state.getValue(), "min", this.props.min),
            _.get(this.accessor.state.getValue(), "max", this.props.max)
        ], "onChange": this.sliderUpdate.bind(this), "onAfterChange": this.sliderUpdateAndSearch.bind(this)})));
    };
