...
var RangeAccessor = (function (_super) {
    ...
    RangeAccessor.prototype.buildSharedQuery = function (query) {
        ...
        if (this.state.hasValue()) {
            ...
            return query
                .addFilter(this.uuid, core_1.BoolMust([rangeFilter]))
    ...
    RangeAccessor.prototype.buildOwnQuery = function (query) {
        ...
        query = query.setAggs(core_1.FilterBucket(this.key, query.getFiltersWithoutKeys(), histogramBucket));
        return query;
        var _a;
    };
...
var RangeFilter = (function (_super) {
    ...
    RangeFilter.prototype.render = function () {
        ...
        return (React.createElement("div", {"className": block()}, React.createElement("div", {"className": block("header")}, this.translate(this.props.title)), React.createElement(Rcslider, {"min": this.props.min, "max": this.props.max, "range": true, "value": [
