...
var RangeFilter = (function (_super) {
    ...
    RangeFilter.prototype.render = function () {
        ...
        return (React.createElement("div", {"className": block()}, React.createElement("div", {"className": block("header")}, this.translate(this.props.title)), React.createElement(Rcslider, {"min": this.props.min, "max": this.props.max, "range": true, "defaultValue": [
