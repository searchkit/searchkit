...
var RangeFilter = (function (_super) {
    ...
    RangeFilter.prototype.getInterval = function () {
    ...
    RangeFilter.prototype.render = function () {
        ...
        return (React.createElement("div", {"className": classname}, React.createElement("div", {"className": block("header")}, this.translate(this.props.title)), histogram, React.createElement(Rcslider, {"min": this.props.min, "max": this.props.max, "range": true, "step": this.getInterval(), "value": [
