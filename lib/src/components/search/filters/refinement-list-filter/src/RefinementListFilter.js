...
var RefinementListFilter = (function (_super) {
    ...
    RefinementListFilter.prototype.renderOption = function (option) {
        ...
        return (React.createElement(core_1.FastClick, {"handler": this.addFilter.bind(this, option), "key": option.key}, React.createElement("div", {"className": optionClassName, "data-qa": "option", "ref": option.key}, React.createElement("div", {"data-qa": "checkbox", "className": block("checkbox").state({ selected: isSelected })}), React.createElement("div", {"data-qa": "label", "className": block("text")}, this.translate(option.key)), React.createElement("div", {"data-qa": "count", "className": block("count")}, option.doc_count))));
    };
