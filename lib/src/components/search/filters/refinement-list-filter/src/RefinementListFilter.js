...
var RefinementListFilter = (function (_super) {
    ...
    RefinementListFilter.prototype.defineAccessor = function () {
        return new core_1.FacetAccessor(this.props.field, { id: this.props.id, operator: this.props.operator, title: this.props.title, size: (this.props.size || 50) });
    };
    ...
    RefinementListFilter.prototype.renderShowMore = function () {
        ...
        return (React.createElement(core_1.FastClick, {"handler": this.toggleViewMoreOption.bind(this, option)}, React.createElement("div", {"data-qa": "show-more", "className": this.bemBlocks.container("view-more-action")}, this.translate(option.label))));
    };
    RefinementListFilter.prototype.toggleCollapse = function () {
    ...
    RefinementListFilter.prototype.componentWillUpdate = function (props, state) {
    ...
    RefinementListFilter.prototype.render = function () {
        ...
        return (React.createElement("div", {"data-qa": "filter--" + this.props.id, "className": className}, React.createElement(core_1.FastClick, {"handler": this.toggleCollapse.bind(this)}, React.createElement("div", {"data-qa": "header", "className": block("header")}, this.props.title)), React.createElement("div", {"data-qa": "options", "className": block("options")}, _.map(this.accessor.getBuckets(), this.renderOption.bind(this))), this.renderShowMore()));
    };
