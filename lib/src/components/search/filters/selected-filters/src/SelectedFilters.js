...
var SelectedFilters = (function (_super) {
    ...
    SelectedFilters.prototype.render = function () {
        ...
        return (React.createElement("div", {"className": this.bemBlocks.container()}, _.map(this.getFilters(), this.renderFilter.bind(this))));
    };
    SelectedFilters.propTypes = _.defaults({}, core_1.SearchkitComponent.propTypes);
