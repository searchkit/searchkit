...
var ResetFilters = (function (_super) {
    ...
    ResetFilters.prototype.renderResetButton = function () {
        ...
        return (React.createElement("div", {"className": block("reset")}, this.translate("ClearAllFilters")));
    };
    ...
    ResetFilters.propTypes = _.defaults({}, core_1.SearchkitComponent.propTypes);
    return ResetFilters;
