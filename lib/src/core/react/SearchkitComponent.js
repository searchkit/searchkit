...
var SearchkitComponent = (function (_super) {
    ...
    SearchkitComponent.prototype.translate = function (key, interpolations) {
        if (interpolations === void 0) { interpolations = {}; }
    ...
    SearchkitComponent.translationsPropType = function (translations) {
        return function (props, propName, componentName) {
            ...
            var translationKeys = _.keys(translations);
            var missing = _.without.apply(_, [_.keys(specifiedTranslations)].concat(translationKeys));
            if (missing.length > 0) {
