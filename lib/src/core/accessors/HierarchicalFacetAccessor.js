...
var HierarchicalFacetAccessor = (function (_super) {
    ...
    HierarchicalFacetAccessor.prototype.computeUuids = function () {
        var _this = this;
        this.uuids = _.map(this.options.fields, function (field) { return _this.uuid + field; });
    };
    ...
    HierarchicalFacetAccessor.prototype.buildSharedQuery = function (query) {
        ...
        _.each(this.options.fields, function (field, i) {
            ...
            var filterTerms = _.map(filters, _1.TermQuery.bind(null, field));
    ...
    HierarchicalFacetAccessor.prototype.buildOwnQuery = function (query) {
        ...
        var lvlAggs = _.compact(_.map(this.options.fields, function (field, i) {
            if (_this.state.levelHasFilters(i - 1) || i == 0) {
                return _1.FilterBucket(field, query.getFiltersWithKeys(_.take(_this.uuids, i)), _1.TermsBucket(field, field, { size: _this.options.size }));
            }
        }));
