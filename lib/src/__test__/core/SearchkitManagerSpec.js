...
describe("SearchkitManager", function () {
    ...
    it("getHitsCount(), hasHits()", function () {
        ...
        expect(_this.searchkit.getHitsCount()).toEqual(99);
        expect(_this.searchkit.hasHits()).toBe(true);
    });
    it("setQueryString()", function () {
        spyOn(_this.accessors, "setQueryString");
        _this.searchkit.setQueryString("foo");
        expect(_this.accessors.setQueryString).toHaveBeenCalledWith("foo");
    });
    it("resetFilters()", function () {
        spyOn(_this.accessors, "resetFilters");
        _this.searchkit.resetFilters();
        expect(_this.accessors.resetFilters)
            .toHaveBeenCalled();
    });
