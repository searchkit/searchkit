...
describe("PaginationAccessor", function () {
    ...
    it("Fix bug in conjunctionn with PageSizeAccessor", function () {
        ...
        var accessors = new _1.AccessorManager([pagination, pageSize]);
        var query = accessors.buildQuery(new _1.ImmutableQuery());
