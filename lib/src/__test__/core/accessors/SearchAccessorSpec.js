var _this = this;
var _1 = require("../../../");
describe("SearchAccessor", function () {
    describe("prefix", function () {
        beforeEach(function () {
            _this.accessor = new _1.SearchAccessor("q", {
        ...
        it("buildSharedQuery()", function () {
            ...
            expect(query.query.query.$array).toEqual([
                _1.BoolShould([
                    _1.BoolShould([
                        _1.MatchPhrasePrefix("some query", "title^10"),
                        _1.MatchPhrasePrefix("some query", "keywords")
                    ]),
...
//# sourceMappingURL=SearchAccessorSpec.js.map