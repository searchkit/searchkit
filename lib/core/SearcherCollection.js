var StatefulAccessor_1 = require("./accessors/StatefulAccessor");
...
var SearcherCollection = (function () {
    ...
    SearcherCollection.prototype.getStatefulAccessors = function () {
        return _.filter(this.getAccessors(), function (accessor) {
            return accessor instanceof StatefulAccessor_1.StatefulAccessor;
        });
    };
    ...
    SearcherCollection.prototype.setAccessorStates = function (query) {
        _.each(this.getStatefulAccessors(), function (accessor) { return accessor.fromQueryObject(query); });
    };
