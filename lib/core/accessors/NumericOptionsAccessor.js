...
var NumericOptionsAccessor = (function (_super) {
    ...
    NumericOptionsAccessor.prototype.buildOwnQuery = function (query) {
        return query.setAggs(query_1.FilterBucket(this.key, query.getFiltersWithoutKeys(this.key), query_1.RangeBucket(this.key, this.options.field, this.getRanges())));
    };
