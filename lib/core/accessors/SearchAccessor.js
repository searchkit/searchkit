...
var SearchAccessor = (function (_super) {
    ...
    SearchAccessor.prototype.buildSharedQuery = function (query) {
        ...
        if (queryStr) {
            ...
            var prefixQueries = this.options.prefixSearch ? QueryBuilders_1.BoolShould(_.map(this.options.queryFields, QueryBuilders_1.MatchPhrasePrefix.bind(null, queryStr))) : [];
