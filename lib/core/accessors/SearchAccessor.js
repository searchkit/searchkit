...
var SearchAccessor = (function (_super) {
    ...
    SearchAccessor.prototype.buildSharedQuery = function (query) {
        ...
        if (queryStr) {
            var simpleQuery = QueryBuilders_1.SimpleQueryString(queryStr, _.extend({}, this.options.queryOptions, {
                "query": queryStr,
                "fields": this.options.queryFields
            }));
            var prefixQueries = this.options.prefixQueryFields ? QueryBuilders_1.BoolShould(_.map(this.options.prefixQueryFields, QueryBuilders_1.MatchPhrasePrefix.bind(null, queryStr))) : [];
