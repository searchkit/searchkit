...
var FacetAccessor = (function (_super) {
    ...
    FacetAccessor.prototype.setSize = function (size) {
    ...
    FacetAccessor.prototype.buildOwnQuery = function (query) {
        ...
        return query.setAggs(QueryBuilders_1.Aggs(this.key, query.getFilters(excludedKey), QueryBuilders_1.Terms(this.key, { size: this.options.size })));
    };
