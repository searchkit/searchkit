...
var NestedFacetAccessor = (function (_super) {
    ...
    NestedFacetAccessor.prototype.buildOwnQuery = function (query) {
        ...
        var addLevel = function (level, ancestors) {
            ...
            _.extend(aggs, QueryBuilders_1.AggsList("lvl" + level, QueryBuilders_1.BoolMust([QueryBuilders_1.Term(levelField, level + 1)].concat(ancestors)), { parents: QueryBuilders_1.Terms(valueField, { size: 0 }) }));
        };
        addLevel(0);
