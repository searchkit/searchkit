...
var StateAcessors = (function () {
    ...
    StateAcessors.prototype.getData = function () {
        var data = new RootBuilder_ts_1.default();
    ...
    StateAcessors.prototype.updateHistory = function () {
        history_ts_1.default.pushState(null, window.location.pathname, this.state.getState());
    };
