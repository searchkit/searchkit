...
var SortingSelector = (function (_super) {
    ...
    SortingSelector.prototype.defineAccessor = function () {
        return new core_1.SortingAccessor("sort", this.props);
    };
    ...
    SortingSelector.prototype.render = function () {
        return (React.createElement("div", {"className": "sorting-selector"}, React.createElement("select", {"onChange": this.updateSorting.bind(this), "value": this.getSelectedValue()}, _.map(this.props.options, this.renderOption.bind(this)))));
    };
