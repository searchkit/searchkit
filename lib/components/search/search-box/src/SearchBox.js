...
var SearchBox = (function (_super) {
    ...
    SearchBox.prototype.render = function () {
        ...
        return (React.createElement("div", {"className": block()}, React.createElement("form", {"onSubmit": this.onSubmit.bind(this)}, React.createElement("div", {"className": block("icon")}), React.createElement(Autosuggest, {"suggestions": this.querySuggestions.bind(this), "suggestionRenderer": this.suggestionRenderer.bind(this), "onSuggestionSelected": this.onSuggestionSelected.bind(this), "suggestionValue": this.suggestionValue, "value": this.getValue(), "inputAttributes": inputAttributes}), React.createElement("input", {"type": "submit", "value": "search", "className": block("action")}), React.createElement("div", {"className": block("loader").mix("sk-spinning-loader").state({ hidden: !this.isLoading() })}))));
    };
    return SearchBox;
