...
var SearchBox = (function (_super) {
    ...
    SearchBox.prototype.render = function () {
        ...
        return (React.createElement("div", {"className": block().state({ focused: this.state.focused })}, React.createElement("form", {"onSubmit": this.onSubmit.bind(this)}, React.createElement("div", {"className": block("icon")}), React.createElement("input", {"type": "text", "className": block("text"), "placeholder": "search", "value": this.getValue(), "onFocus": this.setFocusState.bind(this, true), "onBlur": this.setFocusState.bind(this, false), "ref": "queryField", "onInput": this.onChange.bind(this)}), React.createElement("input", {"type": "submit", "value": "search", "className": block("action")}), React.createElement("div", {"className": block("loader").mix("sk-spinning-loader").state({ hidden: !this.isLoading() })}))));
    };
    return SearchBox;
