...
var Hits = (function (_super) {
    ...
    Hits.prototype.componentWillMount = function () {
        ...
        this.searchkit.addDefaultQuery(function (query) {
            return query.setHighlight(_this.getHighlightedFields());
        });
    };
    Hits.prototype.getHighlightedFields = function () {
        _;
        return {
            fields: _.mapValues(_.object(this.props.highlightFields), _.constant({}))
        };
    };
    ...
    Hits.prototype.renderNoResults = function () {
        return (React.createElement("div", {"data-qa": "no-results", "className": this.bemBlocks.container("no-results")}, "No results"));
    };
