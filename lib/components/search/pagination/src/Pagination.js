...
var Pagination = (function (_super) {
    ...
    Pagination.prototype.paginationElement = function (direction, cssClass, displayText) {
        ...
        return (React.createElement(core_1.FastClick, {"handler": this.setPage.bind(this, direction)}, React.createElement("div", {"className": className}, React.createElement("div", {"className": this.bemBlocks.option("text")}, displayText))));
    };
    Pagination.prototype.render = function () {
        return (React.createElement("div", {"className": this.bemBlocks.container()}, this.paginationElement(DIRECTION.PREVIOUS, "prev", "Previous"), this.paginationElement(DIRECTION.NEXT, "next", "Next")));
    };
    return Pagination;
