...
var Pagination = (function (_super) {
    ...
    Pagination.prototype.paginationElement = function (direction, cssClass, displayText) {
        ...
        return (React.createElement(core_1.FastClick, {"handler": this.setPage.bind(this, direction)}, React.createElement("div", {"className": className, "data-qa": direction}, React.createElement("div", {"className": this.bemBlocks.option("text")}, displayText))));
    };
    Pagination.prototype.render = function () {
        return (React.createElement("div", {"className": this.bemBlocks.container(), "data-qa": "pagination"}, this.paginationElement(DIRECTION.PREVIOUS, "prev", (this.props.prevLinkText || "Previous")), this.paginationElement(DIRECTION.NEXT, "next", (this.props.nextLinkText || "Next"))));
    };
    return Pagination;
