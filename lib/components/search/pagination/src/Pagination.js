...
var Pagination = (function (_super) {
    ...
    Pagination.prototype.paginationElement = function (direction, cssClass, displayText) {
        ...
        return (React.createElement("div", {"onMouseDown": this.leftMouseDown(this.setPage.bind(this, direction)), "className": className}, React.createElement("div", {"className": "pagination-nav-item__text"}, displayText)));
        var _a;
    };
