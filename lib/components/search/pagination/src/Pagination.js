...
var Pagination = (function (_super) {
    ...
    Pagination.prototype.render = function () {
        return (React.createElement("div", {"className": this.bemBlocks.container(), "data-qa": "pagination"}, this.paginationElement(DIRECTION.PREVIOUS, "prev", "Previous"), this.paginationElement(DIRECTION.NEXT, "next", "Next")));
    };
    return Pagination;
