...
var MenuFilter = (function (_super) {
    ...
    MenuFilter.prototype.renderOption = function (option) {
        ...
        return (React.createElement("div", {"className": optionClassName, "key": option.key, "onMouseDown": this.leftMouseDown(this.addFilter.bind(this, option))}, React.createElement("div", {"className": "menu-list-option__text"}, option.key)));
    };
    MenuFilter.prototype.renderAllOption = function () {
        ...
        return (React.createElement("div", {"className": optionClassName, "key": "all", "onMouseDown": this.leftMouseDown(this.addFilter.bind(this, "all"))}, React.createElement("div", {"className": "menu-list-option__text"}, "All")));
    };
