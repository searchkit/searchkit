...
var MenuFilter = (function (_super) {
    ...
    MenuFilter.prototype.render = function () {
        ...
        return (React.createElement("div", {"className": className}, React.createElement("div", {"className": "menu-list__header"}, this.props.title), React.createElement("div", {"className": "menu-list-options"}, this.renderAllOption(), _.map(this.accessor.getBuckets(), this.renderOption.bind(this)))));
        var _a;
    };
    return MenuFilter;
