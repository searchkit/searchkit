...
var MenuFilter = (function (_super) {
    ...
    MenuFilter.prototype.renderOption = function (option) {
        ...
        return (React.createElement(core_1.FastClick, {"handler": this.addFilter.bind(this, option)}, React.createElement("div", {"className": optionClassName, "key": option.key}, React.createElement("div", {"className": "menu-list-option__text"}, this.translate(option.key)))));
    };
