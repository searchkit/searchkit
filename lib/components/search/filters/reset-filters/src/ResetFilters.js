...
var ResetFilters = (function (_super) {
    ...
    ResetFilters.prototype.renderResetButton = function () {
        return (React.createElement("div", {"className": "reset-filters", "onMouseDown": this.leftMouseDown(this.resetFilters.bind(this))}, React.createElement("div", {"className": "reset-filters__text"}, "clear all filters")));
    };
