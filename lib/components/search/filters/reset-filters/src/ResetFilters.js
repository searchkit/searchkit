...
var ResetFilters = (function (_super) {
    ...
    ResetFilters.prototype.renderResetButton = function () {
        ...
        return (React.createElement(core_1.FastClick, {"handler": this.resetFilters.bind(this)}, React.createElement("div", {"className": block().state({ disabled: !this.hasFilters() })}, React.createElement("div", {"className": block("reset")}, "clear all filters"))));
    };
