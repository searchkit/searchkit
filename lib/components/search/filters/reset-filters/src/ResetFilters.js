...
var ResetFilters = (function (_super) {
    ...
    ResetFilters.prototype.renderResetButton = function () {
        return (React.createElement(core_1.FastClick, {"handler": this.resetFilters.bind(this)}, React.createElement("div", {"className": "reset-filters"}, React.createElement("div", {"className": "reset-filters__text"}, "clear all filters"))));
    };
