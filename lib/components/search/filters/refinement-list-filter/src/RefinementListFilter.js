...
var FacetAccessor_1 = require("../../../../../domain/new/accessors/FacetAccessor");
...
var RefinementListFilter = (function (_super) {
    ...
    RefinementListFilter.prototype.defineAccessor = function () {
        return new FacetAccessor_1.default(this.props.field, { operator: this.props.operator, title: this.props.title });
    };
