...
var RefinementListFilter = (function (_super) {
    ...
    RefinementListFilter.prototype.renderOption = function (option) {
        ...
        return (React.createElement(core_1.FastClick, {"handler": this.addFilter.bind(this, option)}, React.createElement("div", {"className": optionClassName, "key": option.key}, React.createElement("div", {"className": checkedClassName}), React.createElement("div", {"className": "refinement-option__text"}, option.key), React.createElement("div", {"className": "refinement-option__count"}, option.doc_count))));
    };
