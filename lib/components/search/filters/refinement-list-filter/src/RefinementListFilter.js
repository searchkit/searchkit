...
var RefinementListFilter = (function (_super) {
    ...
    RefinementListFilter.prototype.renderShowMore = function () {
        ...
        return (React.createElement(core_1.FastClick, {"handler": this.toggleViewMoreOption.bind(this, option)}, React.createElement("div", {"className": this.bemBlocks.container("view-more-action")}, option.label)));
    };
