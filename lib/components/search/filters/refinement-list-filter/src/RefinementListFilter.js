...
var RefinementListFilter = (function (_super) {
    ...
    RefinementListFilter.prototype.toggleViewMore = function () {
    ...
    RefinementListFilter.prototype.renderShowMore = function () {
        var label = this.state.showMore ? "view less" : "view more";
        return (React.createElement(core_1.FastClick, {"handler": this.toggleViewMore.bind(this)}, React.createElement("div", {"className": this.bemBlocks.container("view-more-action")}, label)));
    };
