...
var FacetAccessor_ts_1 = require("../../../../../domain/accessors/FacetAccessor.ts");
...
var RefinementListFilter = (function (_super) {
    ...
    RefinementListFilter.prototype.defineAccessor = function () {
        return new FacetAccessor_ts_1.default(this.props.field, { operator: this.props.operator, title: this.props.title });
    };
