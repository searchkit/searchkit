...
var SelectedFilters = (function (_super) {
    ...
    SelectedFilters.prototype.renderFilter = function (filter) {
        ...
        return (React.createElement("div", {"className": className, "key": filter.$name + ":" + filter.$value}, React.createElement("div", {"className": "selected-filter__name"}, filter.$name, ": ", filter.$value), React.createElement(core_1.FastClick, {"handler": this.removeFilter.bind(this, filter)}, React.createElement("div", {"className": "selected-filter__remove-action"}, "x"))));
        var _a;
    };
