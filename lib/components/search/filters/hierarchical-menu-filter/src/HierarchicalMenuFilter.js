...
var HierarchicalMenuFilter = (function (_super) {
    ...
    HierarchicalMenuFilter.prototype.renderOption = function (level, option) {
        ...
        return (React.createElement("div", {"key": option.key}, React.createElement(core_1.FastClick, {"handler": this.addFilter.bind(this, option, level)}, React.createElement("div", {"className": className}, React.createElement("div", {"className": "hierarchical-menu-option__text"}, this.translate(option.key)), React.createElement("div", {"className": "hierarchical-menu-option__count"}, option.doc_count))), (function () {
