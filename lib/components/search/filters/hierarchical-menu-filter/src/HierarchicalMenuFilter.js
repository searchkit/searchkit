...
var HierarchicalMenuFilter = (function (_super) {
    ...
    HierarchicalMenuFilter.prototype.defineAccessor = function () {
        return new core_1.HierarchicalFacetAccessor(this.props.id, { title: this.props.title, fields: this.props.fields });
    };
    ...
    HierarchicalMenuFilter.prototype.renderOption = function (level, option) {
        var _this = this;
        return (React.createElement("div", null, React.createElement("div", {"key": option.key, "onClick": this.addFilter.bind(this, option, level)}, option.key, " (", option.doc_count, ")"), React.createElement("div", null, (function () {
    ...
    HierarchicalMenuFilter.prototype.renderOptions = function (level) {
        return (React.createElement("div", {"className": "hierarchical-options"}, _.map(this.accessor.getBuckets(level), this.renderOption.bind(this, level))));
    };
    HierarchicalMenuFilter.prototype.render = function () {
        return (React.createElement("div", null, this.renderOptions(0)));
    };
