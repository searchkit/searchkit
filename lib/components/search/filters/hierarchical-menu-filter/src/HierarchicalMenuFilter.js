...
var HierarchicalMenuFilter = (function (_super) {
    ...
    HierarchicalMenuFilter.prototype.renderOption = function (level, option) {
        ...
        return (React.createElement("div", null, React.createElement("div", {"className": className, "key": option.key, "onClick": this.addFilter.bind(this, option, level)}, option.key, " (", option.doc_count, ")"), React.createElement("div", null, (function () {
    ...
    HierarchicalMenuFilter.prototype.render = function () {
        return (React.createElement("div", {"className": "hierarchical-menu-list"}, React.createElement("div", {"className": "hierarchical-menu-list__header"}, this.props.title), this.renderOptions(0)));
    };
