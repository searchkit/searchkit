...
var HierarchicalFacetAccessor_ts_1 = require("../../../../../domain/accessors/HierarchicalFacetAccessor.ts");
...
var HierarchicalMenuFilter = (function (_super) {
    ...
    HierarchicalMenuFilter.prototype.createAccessors = function () {
        ...
        this.accessors = this.props.fields.map(function (field, i) {
            ...
            return _this.searcher.stateManager.registerAccessor(new HierarchicalFacetAccessor_ts_1.default(field, { title: _this.props.title, size: 100, fields: ignoreKeys }));
        });
    };
