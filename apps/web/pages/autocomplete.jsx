...
import { InstantSearch, usePagination, useSearchBox, Hits } from 'react-instantsearch'
...
function createCategoriesPlugin({ autocompleteClient, setInstantSearchUiState }) {
  return {
...
export default function AutocompletePage() {
  return (
    <div className="bg-gray-100 h-screen p-4">
      ...
      <InstantSearch searchClient={searchClient} indexName="imdb_movies" routing>
