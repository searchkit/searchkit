---
title: Indexing data into Elasticsearch
description: Indexing data into Elasticsearch for use with Instantsearch and Searchkit
---

## Setting up Elasticsearch

This tutorial will guide you through the process of setting up Elasticsearch, to be used with Instantsearch and Searchkit. We will be using a sample movie data-set of around 1000 movies.
