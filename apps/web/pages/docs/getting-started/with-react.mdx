...
import { InstantSearch, SearchBox, Hits, RefinementList, HierarchicalMenu } from 'react-instantsearch-dom';
...
Then you can add the `NumericMenu` component to the `App` function.

```tsx

import { InstantSearch, SearchBox, Hits, RefinementList, HierarchicalMenu, NumericMenu } from 'react-instantsearch-dom';
...
Then you should see the price refinement options.

![overview](../../../public/docs/getting-started/screen8.png)
...
import { InstantSearch, SearchBox, Hits, RefinementList, HierarchicalMenu, NumericMenu, Pagination } from 'react-instantsearch-dom';
...
import { InstantSearch, SearchBox, Hits, RefinementList, HierarchicalMenu, NumericMenu, Pagination, Configure } from 'react-instantsearch-dom';
...
```tsx
import { DynamicWidgets } from 'instantsearch-react-dom'
...
on the frontend, you use the `CustomQueryRule` component to display the banner.

```tsx
import { QueryRuleCustomData } from 'instantsearch-react-dom'
