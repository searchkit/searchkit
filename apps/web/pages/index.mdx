...
<FeatureBreakout title="Algolia Instantsearch Compatible" description="Searchkit uses instantsearch, which means you can use the instantsearch libraries to build your search experience." linkTitle="Filters Docs" linkHref="/docs/guides/applying-filters" subtext="React, Vue. You don't even need frontend skills. Query Rules, Facets (Hierarchical, Ranges, Menus) all supported." />
<FeatureBreakout title="Open source and free to use" description="Searchkit is open source, which means you can use it for free and contribute to the project. It's battle tested and used in production by many companies" linkTitle="View Github" linkHref="https://github.com/searchkit/searchkit" />
<FeatureBreakout title="Run anywhere, your choice" description="Searchkit can integrate anywhere. Instantsearch provides support for many different frameworks. Searchkit API can run anywhere for node. Either in your code or in a worker within cloudflare. Your choice" linkTitle="Cloudflare example" linkHref="/docs/examples/cloudflare-workers" />

<h2 className="text-left md:text-left text-3xl tracking-tight font-extrabold text-gray-100 sm:text-3xl lg:text-3xl xl:text-3xl mt-12">Search Relevance Features</h2>

<FeatureBreakout title="Query Rules" description="Query rules are a powerful feature that allows you to customize the behavior of the search experience. You can use query rules to boost or filter results, or to change the ranking of results." linkTitle="Query Rules Docs" linkHref="/docs/guides/query-rules" />
<FeatureBreakout title="Semantic Search Capable" description="Searchkit supports the full power of Elasticsearch, which means you can use the Elasticsearch Query DSL to tune your relevance and use features like Elasticsearch semantic search." />
