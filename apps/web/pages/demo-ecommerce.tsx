...
const hitView = (props: any) => {
  return (
    <div>
      ...
      <h3>
        <Highlight hit={props.hit} attribute="designerName" />
      </h3>
      <p>
        ...
        >
          ...
          <div className="left-panel">
            <Panel header="Categories">
              <HierarchicalMenu
                attributes={['categories_lvl1', 'categories_lvl2', 'categories_lvl3']}
              />
            </Panel>
            ...
            <ToggleRefinement attribute="outOfStock" label="Out of Stock" />
          </div>
...
export const getServerSideProps: GetServerSideProps<WebProps> = async function getServerSideProps({
  req
}) {
